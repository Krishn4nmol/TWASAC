...
SEED_PATH = "trained_model_tascar_seed123/"
...
if diff > 0:
    print(f"Beats CASR by {diff:.3f}pp! ✅")
    print(f"\nCopying to best/...")
    ...
    for f in os.listdir(best_path):
        shutil.copy2(
            ...
            os.path.join(best_folder, f))
    print(f"Copied {best_name} to best/!")
else:
    print(f"Does not beat CASR! ❌")
    print(f"RL variance issue!")